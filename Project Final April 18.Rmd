...
read_distribution.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Irinotecan_Rep_1.Aligned.sortedByCoord.out.bam -r hg38_MANE.bed > Irinotecan_Rep_1_rseqc_read_distribution.out

read_distribution.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Irinotecan_Rep_2.Aligned.sortedByCoord.out.bam -r hg38_MANE.bed > Irinotecan_Rep_2_rseqc_read_distribution.out

read_distribution.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Vehicle_Rep_1.Aligned.sortedByCoord.out.bam -r hg38_MANE.bed > Vehicle_Rep_1_rseqc_read_distribution.out

read_distribution.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Vehicle_Rep_2.Aligned.sortedByCoord.out.bam -r hg38_MANE.bed > Vehicle_Rep_2_rseqc_read_distribution.out
...
geneBody_coverage.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Irinotecan_Rep_1.Aligned.sortedByCoord.out.bam \
-r hg38.HouseKeepingGenes.bed \
-o Irinotecan_Rep_1_geneBody_coverage.out

geneBody_coverage.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Irinotecan_Rep_2.Aligned.sortedByCoord.out.bam \
-r hg38.HouseKeepingGenes.bed \
-o Irinotecan_Rep_2_geneBody_coverage.out

geneBody_coverage.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Vehicle_Rep_1.Aligned.sortedByCoord.out.bam \
-r hg38.HouseKeepingGenes.bed \
-o Vehicle_Rep_1_geneBody_coverage.out

geneBody_coverage.py -i /athena/angsd/scratch/sah4030/angsd_homework/Project/Final/AlignReads/Vehicle_Rep_2.Aligned.sortedByCoord.out.bam \
-r hg38.HouseKeepingGenes.bed \
-o Vehicle_Rep_2_geneBody_coverage.out
```

### STEP 6: Performing Multiqc 
```{bash multiqc 2, eval = FALSE}
mamba activate multiqc
multiqc -n RseQC.multiqc .
...
### STEP 11: Check whether normalization helped adjust global differences between the samples.
...
### STEP 5: Explore Top Overrepresented GO Terms
...
### STEP 8: Dot plot of GSEA Results
